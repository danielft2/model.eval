  ...
  return (
    <div className="flex flex-col items-center space-y-8">
      ...
      <div className="flex w-[800px] space-x-5">
        <div className="hover:border-brand-700 hover:bg-brand-50/40 transition-colors h-60 flex flex-col space-y-5 cursor-pointer justify-center items-center flex-1 bg-slate-50 border border-slate-300 rounded-xl px-5 py-6">
          <Image
          ...
          <div className="text-center">
            ...
            <p className="font-medium font-body text-slate-600 text-sm max-w-[40ch]">
              Avalie seu modelo com métricas automáticas e confira os resultados
              na hora.
            </p>
          </div>
        </div>
